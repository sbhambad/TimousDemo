...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'chords');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Chords');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.ticksy.com');
