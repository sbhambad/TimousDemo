...
class CI_Newsletter extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if(ci_setting('newsletter_action')!=''):
			?>
			<form action="<?php ci_e_setting('newsletter_action'); ?>" method="post" class="ci-newsletter-form">
				<div class="row">
					<div class="<?php echo $text_cols; ?> col-sm-12">
						<label for="<?php ci_e_setting('newsletter_email_id'); ?>"><?php echo $title; ?></label>
						<span><?php echo $description; ?></span>
					</div>

					<div class="<?php echo $form_cols; ?> col-sm-12">
						<div class="input-group">
							<input type="email" name="<?php ci_e_setting('newsletter_email_name'); ?>" id="<?php ci_e_setting('newsletter_email_id'); ?>" placeholder="<?php _e('Your e-mail', 'ci_theme'); ?>">
	...
	function form($instance){
		...
		<p><label><?php _e('Description:', 'ci_theme'); ?></label><input id="<?php echo $this->get_field_id('description'); ?>" name="<?php echo $this->get_field_name('description'); ?>" type="text" value="<?php echo esc_attr($description); ?>" class="widefat" /></p>
